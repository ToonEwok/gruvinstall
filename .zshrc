...
alias b="~/.apps/shellscripts/budget.sh"
alias p="sudo pacman -S"
alias y="yay -S"
alias d="dict"
alias ts="~/.apps/shellscripts/sersync.sh"
alias edit="nvim ~/.zshrc"
alias nitro="nitrogen ~/Pictures/Wallpapers"
alias pipes="~/.apps/shellscripts/pipes.sh -c 3,4,5,6 -p 3 -r 4000"
alias rain="~/.apps/shellscripts/rain.sh"
...
alias vmc="sudo ~/.apps/shellscripts/vmcopy.sh"
alias vmm="sudo ~/.apps/shellscripts/vmmnt.sh"
